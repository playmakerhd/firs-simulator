...
  const htmlUrl = `${req.protocol}://${req.get('host')}/invoice/view/${irn}`;
...
  res.setHeader('Content-Disposition', `attachment; filename=invoice_${irn}.pdf`);
  res.send(pdfBuffer);
});
module.exports = router;   // ESM: export default router;
// -- 🚀 Start Server --
